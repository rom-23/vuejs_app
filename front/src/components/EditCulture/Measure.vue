...
import MeasuresDatatable from "@/components/EditCulture/MeasuresDatatable.vue";
import MeasuresBoosterDatatable from "@/components/EditCulture/BoosterDataTable.vue";
export default {
  name: "Measure",
  components: { alertMe, MeasuresDatatable, MeasuresBoosterDatatable },
